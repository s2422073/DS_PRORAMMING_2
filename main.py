...
class SciActionButton(CalcButton):
    def __init__(self, text, button_clicked):
        CalcButton.__init__(self, text, button_clicked)
    ...
    def __init__(self):
        ...
        self.content = ft.Column(
            controls=[
                ...
                ft.Row(
                    controls=[
                        SciActionButton(text="sqrt", button_clicked=self.button_clicked),
                        SciActionButton(text="x^2", button_clicked=self.button_clicked),
                        SciActionButton(text="log", button_clicked=self.button_clicked),
                        SciActionButton(text="sin", button_clicked=self.button_clicked),
                        SciActionButton(text="cos", button_clicked=self.button_clicked),
                        SciActionButton(text="tan", button_clicked=self.button_clicked),
                    ]
                ),
            ]
        )
